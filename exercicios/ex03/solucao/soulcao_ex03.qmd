...
**1.** Baixe o arquivo `fred.csv` e coloque esse arquivo na pasta 
utilizando a url disponibilizada e a funcão `readr::read_csv()`, armazene 
os dados importados no objeto `taxas_juros`, analise a estrutura dos 
...
taxas_juros <- readr::read_csv(url)

# visao geral da estrutura dos dados
dplyr::glimpse(taxas_juros)

# elimine a primeira coluna da series_juros
